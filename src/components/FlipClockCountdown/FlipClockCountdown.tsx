...
const defaultRenderMap = [true, true, true, true, true];
const defaultLabels = ['Weeks', 'Days', 'Hours', 'Minutes', 'Seconds'];
...
function FlipClockCountdown(props: FlipClockCountdownProps) {
  ...
  const sections = React.useMemo(() => {
    ...
    const _renderMap = renderMap.length >= 5 ? renderMap.slice(0, 5) : defaultRenderMap;
    const _labels = labels.length >= 5 ? labels.slice(0, 5) : defaultLabels;
